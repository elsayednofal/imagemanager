            ...
            <div class="modal-body">
                <div>
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="nav-item"><a href="#image_manger_choose_<?= $id ?>" class="nav-link image_manger_choose_button active" aria-controls="choose" role="tab" data-toggle="tab">Choose</a></li>
                        <li role="presentation" class="nav-item"><a href="#image_manger_upload_<?= $id ?>" class="nav-link image_manger_upload_button" aria-controls="upload" role="tab" data-toggle="tab">Upload</a></li>
                    </ul>
